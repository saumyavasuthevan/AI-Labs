...
| :--- | :--- | :--- |
| **Claude Code** | [Competitive Intel Agent](/.claude/agents/competitive-intel.md) | Created a competitive intel agent that tracks **shifts** in threats by tracking changes in competitor strengths and weaknesses over time using **memory**. |
